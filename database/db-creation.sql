...
CREATE TABLE IF NOT EXISTS public.classification(
  ...
  classification_isvisible BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS public.inventory(
    ...
    inv_isvisible BOOLEAN NOT NULL DEFAULT FALSE,
...
-- Adding constraint foreign key classification_id between
-- tables 'inventory' and 'classification'
...
INSERT INTO public.classification(classification_name, classification_isvisible)
VALUES ('Custom', TRUE),
    ('Sport', TRUE),
    ('SUV', TRUE),
    ('Truck', TRUE),
...
--Updating inventory image and thumbnail links
UPDATE public.inventory
	SET inv_thumbnail = REPLACE(inv_thumbnail, 'images/', 'images/vehicles/'),
		inv_image = REPLACE(inv_image, 'images/', 'images/vehicles/');

--Inserting ADMIN and EMPLOYEE ACCOUNTS
INSERT INTO public.account (account_firstname, account_lastname, account_email, account_password, account_type)
VALUES ('Manager', 'User', 'manager@340.edu', '$2a$10$IXdqUQoRR7DGSKnDkEyYF.iqlbKNi/WQUQqbZPAJ1qgJrKhABcsWK', 'Admin'),
       ('Happy', 'Employee', 'happy@340.edu', '$2a$10$BgQuqu5IdwOL8GqDxsnobux6FQwNKQla2gfdZ7Rel7N8zkTKrC8CW', 'Employee');