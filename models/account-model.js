...
async function getAccountByEmail(account_email){
    try{
        const result = await pool.query("SELECT account_id, account_firstname, account_lastname, account_type, account_email, account_password FROM PUBLIC.ACCOUNT WHERE account_email = $1", [account_email]);
